...
<head>
    ...
    <title>Healing Hands Hospital - Time Slots</title>
...
<section class="bg-image d-flex justify-content-center align-items-start"
    ...
    <div class="card shadow-lg p-4 w-100"
         style="max-width: 800px; background: rgba(255,255,255,0.95); border-radius: 12px;">
                <div class="card-body">
                    <h2 class="card-title text-center mb-4 text-success fw-bold">Manage Specialization Time Slots</h2>

                    <form action="saveTime" method="post" class="mb-5">
                        <div class="row g-3">
                            <div class="col-12">
